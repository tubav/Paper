...
% ---- Authors IEEE style ------------------------------
%------------ Alex-----------------------
\newcommand{\authorOne}{\IEEEauthorblockN{X. Todo}
\metaInstituteFirst}

%----------- X Todo ------------------
\newcommand{\authorTwo}{\IEEEauthorblockN{Y. Todo}
\metaInstituteSecond}

% -------- Institutions/Organisations -------------------------
%--------- Uni Bonn ----------------------------
\newcommand{\metaInstituteFirst}{\IEEEauthorblockA{University X,
City, Country\\ Department\\
todo@example.org}}

%------------ X Todo -----------------------
\newcommand{\metaInstituteSecond}{\IEEEauthorblockA{University Y,
City, Country\\ Department\\
todo@example.org}}
